...
export interface PurificationCardProps {
  id: number;
  batchNo: string;
...
const statusStyles: Record<PurificationCardProps['status'], string> = {
  'in-progress': 'bg-yellow-500 text-black',
  completed: 'bg-green-500 text-white',
};

export const PurificationCard = ({
  id,
  batchNo,
  date,
  solvent,
  ...
  >
    <div className="flex-1 space-y-1">
      <h3 className="text-lg font-semibold">Purification #{id}</h3>
      <p className="text-sm">
